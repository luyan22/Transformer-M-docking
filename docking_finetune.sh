...
echo "========================================================================================"
#!/bin/bash
# export LD_LIBRARY_PATH=/usr/local/cuda-11.6/lib64/:/home/AI4Science/fengsk/.conda/envs/Shikun/lib:$LD_LIBRARY_PATH

DS_Tasks=('ADRB2' 'ABL1' 'CYT2C9' 'PPARG' 'GluA2' '3CL' 'HIVINT' 'HDAC2' 'KRAS' 'PDE5')
fold=(0 1 2 3 4)

expname="k_fold_docking"


for dataset in "${DS_Tasks[@]}"; do
    for runseed in "${fold[@]}"; do
        # python -u chem/finetune_docking.py --input_model_file /home/AI4Science/fengsk/GraphMAE/chem/init_weights/pretrained.pth --dataset "$dataset" --runseed "$runseed" --filename "$expname" --input_model_file /home/AI4Science/luy2402/GraphMAE_docking/chem/init_weights/pretrained.pth --split k_fold  --fold "$runseed" > "$expname"_"$dataset"_"$runseed".log
